                    ...
                    existedFields.keys.forEach((element) => {
                        switch (element) {
                            ...
                            case "confirm_password":
                                ...
                                break;
                            case "cardNumber":
                                !validateCreditCard(obj["cardNumber"]) && existedFields.emptyKeys.push({ fieldName: element, message: "Invalid Card no" });
                                break;
                            case "cardCvc":
                                !validateCvc(obj["cardCvc"]) && existedFields.emptyKeys.push({ fieldName: element, message: "cvc only 3 digit" });
                                break;
                        }
                    });
